...
// car, user, rent storage
class CarStorage extends Storage
{
  public function __construct()
  {
    parent::__construct(new JsonIO('json/cars.json'));
  }
}
class UserStorage extends Storage
{
  public function __construct()
  {
    parent::__construct(new JsonIO('json/users.json'));
  }
}

class RentStorage extends Storage
{
  public function __construct()
  {
    parent::__construct(new JsonIO('json/rents.json'));
  }
}
